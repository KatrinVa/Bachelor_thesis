...
This is results of my bacholors thesis  "Evaluation of Strategies for Automated Segmentation of Cryo-Volume-EM Data" writen as final projeck of my biophysisc study at Masaryk Univesity in Brno. Where I study compared various neural network architectures (2D, 2.5D, and
3D), specifically examining the U-Net and DeepLabv3+ models. The study also
examined how training parameters, such as patch size, number of patches per
...
The study also evaluated how different training parameters influenced segmentation performance, including patch size, number of patches per micrograph, batch size, mask configuration, and number of training epochs.
...
More details are available in the thesis PDF: `nazev.pdf`.
